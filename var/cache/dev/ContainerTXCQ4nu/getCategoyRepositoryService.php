...
// Returns the private 'App\Repository\CategoyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CategoyRepository.php';

return $this->privates['App\\Repository\\CategoyRepository'] = new \App\Repository\CategoyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
